...
class BaseAutomationClient(object):
    ...
    # TODO: must provide device_id, client_version
    def __init__(self, server_url, user_id, device_id=None,
                 client_version=None,
...
#         log.trace("Got token '%s' with cookies %r", token, cookies)
    ...
    def _safe_filename(self, name, replacement=u'-'):
...
#                 log.debug(detail)
    ...
    def _force_decode(self, string, codecs=['utf8', 'cp1252']):
        for codec in codecs:
            try:
